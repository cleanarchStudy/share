...
import accidentalduplicatedshopapp.presentation.ShopRequest;
...
public record ShopCommand(
 ...
 public static ShopCommand from(ShopRequest shop){
 ...
 public Shop toEntity(){
     return new Shop(shopName, address, description);
 }
}
