package org.example.chapter_4.decoupling.history.infrastructure;

import java.util.HashMap;
import java.util.List;
import java.util.Map;
import org.example.chapter_4.decoupling.history.domain.History;
import org.example.chapter_4.decoupling.history.domain.HistoryRepository;
